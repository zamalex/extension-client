              ...
              child: Container(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      padding: const EdgeInsetsDirectional.only(start: kPaddingS, end: kPaddingS, top: 2),
                      child: Row(
                        children: <Widget>[
                          Expanded(
                            child: StrutText(
                    ...
                    if (location.ratings > 0)
                      Padding(
                        padding: const EdgeInsetsDirectional.only(start: kPaddingS, end: kPaddingS, bottom: kPaddingS, top: 2),
                        child: Row(
                          children: <Widget>[
                            const Padding(
                              padding: EdgeInsetsDirectional.only(end: 2),
            ...
            child: InkWell(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: Padding(
                      padding: const EdgeInsets.only(top: kPaddingS, bottom: kPaddingS, left: kPaddingS, right: kPaddingS),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: <Widget>[
                          StrutText(
                          ...
                          if (location.ratings > 0)
                            Padding(
                              padding: const EdgeInsetsDirectional.only(top: 2, end: kPaddingS),
                              child: Row(
                                children: <Widget>[
                                  const Padding(
                                    padding: EdgeInsetsDirectional.only(end: 2),
