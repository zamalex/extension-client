      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              StrutText(
                dateRange > 0 ? L10n.of(context).commonWeekdayShort(DOW.values[date.weekday - 1]) : L10n.of(context).commonWeekdayToday.toUpperCase(),
                style: Theme.of(context).textTheme.bodyText2.copyWith(color: isSelected ? kWhite : Theme.of(context).textTheme.bodyText2.color),
              ),
              StrutText(
                date.day.toString(),
                style: Theme.of(context).textTheme.headline6.copyWith(color: isSelected ? kWhite : Theme.of(context).textTheme.headline6.color),
              ),
              StrutText(
                L10n.of(context).commonMonthShort(Month.values[date.month - 1]).toUpperCase(),
                style: Theme.of(context).textTheme.bodyText2.copyWith(color: isSelected ? kWhite : Theme.of(context).textTheme.bodyText2.color),
              ),
            ],
          ),
