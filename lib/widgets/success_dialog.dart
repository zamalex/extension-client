...
class _BookingSuccessDialogState extends State<SuccessDialog> with TickerProviderStateMixin {
  SuccessDialogIconStatus _successIconStatus = SuccessDialogIconStatus.hidden;
  bool _showButton = false;

  AnimationController iconVisibilityAnimationController, iconSizeAnimationController;
  ...
  void initState() {
    ...
    iconVisibilityAnimationController.addStatusListener((AnimationStatus status) {
  ...
  Widget _drawIcon() {
    ...
    return Opacity(
      opacity: iconOpacity,
      child: Icon(
        _successIconStatus == SuccessDialogIconStatus.visible ? widget.endIcon : widget.startIcon,
        size: 160 + extraSize,
        color: kPrimaryColor,
      ),
    );
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: StrutText(
                          widget.subtitle ?? '',
                          style: Theme.of(context).textTheme.subtitle1.copyWith(color: Theme.of(context).textTheme.caption.color),
                          textAlign: TextAlign.center,
                        ),
                      ),
                    ],
