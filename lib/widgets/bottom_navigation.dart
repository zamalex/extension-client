        ...
        builder: (BuildContext context, AuthState state) {
          return IndexedStack(
            ...
            children: <Widget>[
              ...
              if (getIt.get<AppGlobals>().user != null) const InboxScreen() else const SignInScreen(),
              if (getIt.get<AppGlobals>().user != null) const ProfileScreen() else const SignInScreen(),
            ],
          );
        },
      ),
