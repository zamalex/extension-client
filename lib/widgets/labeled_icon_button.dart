        ...
        children: <Widget>[
          Container(
            ...
            decoration: BoxDecoration(
              color: getIt.get<AppGlobals>().isPlatformBrightnessDark ? Theme.of(context).dividerColor : kPrimaryColor.withAlpha(24),
            ...
            child: showLoading
                ...
                : Icon(
                    icon,
                    size: 32,
                    color: getIt.get<AppGlobals>().isPlatformBrightnessDark ? Theme.of(context).textTheme.button.color.withOpacity(0.75) : kPrimaryColor,
                  ),
          ),
          const Padding(padding: EdgeInsets.only(top: kPaddingS)),
          StrutText(
            text,
            style: Theme.of(context).textTheme.subtitle1.w500.copyWith(color: Theme.of(context).textTheme.bodyText2.color),
          ),
        ],
      ),
    );
