                  ...
                  child: IntrinsicHeight(
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Column(
                          children: widget.options.map((ModalBottomSheetItem<dynamic> item) {
                            return ListItem(
                              title: item.text,
                              titleTextStyle: _selected != null && item.text == _selected.text
                                  ? Theme.of(context).textTheme.subtitle1.fs18.primaryColor
                                  : Theme.of(context).textTheme.subtitle1.fs18,
                              trailing: _selected != null && item.text == _selected.text
                                  ? Icon(
