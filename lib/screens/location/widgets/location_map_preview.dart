        ...
        children: <Widget>[
          GoogleMap(
            onMapCreated: (GoogleMapController controller) {
              ...
              setState(() {
                final MarkerId markerId = MarkerId(widget.coordinates.toString());
                _markers.add(Marker(
                  markerId: markerId,
          ...
          Container(
            margin: const EdgeInsetsDirectional.only(end: kPaddingM, bottom: kPaddingS),
            ...
            child: IconButton(
              ...
              color: kWhite,
              onPressed: () => Async.launchUrl('https://www.google.com/maps/dir//${widget.coordinates.latitude},${widget.coordinates.longitude}'),
            ),
          ),
        ],
      ),
