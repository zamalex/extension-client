                      ...
                      child: ListView(
                        children: <Widget>[
                          ListItem(
                            ...
                            subtitle: sprintf('%s\n%s', <String>[widget.appointment.location.address, widget.appointment.location.city]),
                            leading: Padding(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                    image: AssetImage(widget.appointment.location.mainPhoto),
                                    fit: BoxFit.cover,
                                  ),
                                ),
                              ),
                            ...
                            onPressed: () => Navigator.pushNamed(context, Routes.location, arguments: widget.appointment.location.id),
                          ),
                          UppercaseTitle(title: L10n.of(context).reviewLabelRate),
                          Padding(
                              ...
                              children: <Widget>[
                                Container(
                                  ...
                                  child: StarRating(
                                    rating: _rate,
                                    size: 44,
                                    onRatingChanged: (double rating) => setState(() => _rate = rating),
                                  ),
                                ),
                                Expanded(
                                  child: StrutText(
                                    sprintf('%.1f', <double>[_rate]),
                                    style: Theme.of(context).textTheme.headline4.bold.copyWith(color: kPrimaryColor),
                          ...
                          UppercaseTitle(title: L10n.of(context).reviewLabelComment),
                          Padding(
                            padding: const EdgeInsets.only(top: kPaddingS),
                            child: ThemeTextInput(
                              hintText: L10n.of(context).reviewCommentPlaceholder,
                              focusNode: focusNode,
                              textInputAction: TextInputAction.next,
                              maxLines: 5,
                              controller: textEditingController,
                              lengthLimit: kReviewLengthLimit,
                              onChanged: (String value) => setState(() => _charsRemaining = kReviewLengthLimit - value.length),
                            ),
                          ),
                          Padding(
                            padding: const EdgeInsets.symmetric(vertical: kPaddingS),
                            child: Text(
                              L10n.of(context).reviewLengthLimit(_charsRemaining),
                      ...
                      child: ThemeButton(
                        onPressed: () {
                          if (_rate == 0) {
                            ...
                            BlocProvider.of<AppointmentBloc>(context).add(ReviewedAppointmentEvent());
                          }
                        },
