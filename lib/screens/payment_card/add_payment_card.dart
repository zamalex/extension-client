...
import 'package:salon/screens/payment_card/widgets/payment_card_form.dart';
import 'package:salon/screens/payment_card/widgets/payment_card_widget.dart';
...
class _AddPaymentCardScreenState extends State<AddPaymentCardScreen> with PortraitStatefulModeMixin<AddPaymentCardScreen> {
                  ...
                  children: <Widget>[
                    Expanded(
                      child: ListView(children: <Widget>[
                        ...
                        PaymentCardForm(onCreditCardModelChange: _onCreditCardModelChange),
                      ]),
                    ),
                    Padding(
  ...
  void _savePaymentCard() {
    ...
    BlocProvider.of<AuthBloc>(context).add(PaymentCardSavedAuthEvent(paymentCard: _paymentCardModel));
  }
}
