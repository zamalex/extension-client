...
import 'package:salon/screens/payment_card/widgets/animation_card.dart';
import 'package:salon/screens/payment_card/widgets/random_background.dart';
...
class _PaymentCardWidgetState extends State<PaymentCardWidget> with SingleTickerProviderStateMixin {
  ...
  Container _buildFrontContainer(
    ...
    return Container(
      ...
      height: widget.height ?? max(230, orientation == Orientation.portrait ? height / 4 : height / 2),
      child: Stack(
        children: <Widget>[
          RandomBackground(
            height: height,
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: StrutText(
                    widget.cardNumber.isNullOrEmpty ? 'XXXX XXXX XXXX XXXX' : widget.cardNumber,
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        StrutText(
                          widget.expirationDate.isNullOrEmpty ? L10n.of(context).paymentCardWidgetExpirationDatePlaceholder : widget.expirationDate,
                          style: const TextStyle(
                            color: kWhite,
                            fontFamily: 'halter',
                            fontSize: 16,
                  ...
                  child: Padding(
                    ...
                    child: StrutText(
                      widget.cardHolderName.isEmpty || widget.cardHolderName == null
                          ? L10n.of(context).paymentCardWidgetCardHolderPlaceholder
              ...
              children: <Widget>[
                ...
                Expanded(
                  ...
                  child: Align(
                    ...
                    child: Padding(
                      padding: const EdgeInsetsDirectional.only(start: kPaddingM, end: kPaddingM, bottom: kPaddingM),
                      child: _getCardTypeIcon(widget.cardNumber),
                    ),
                  ),
                ),
