...
import 'package:salon/utils/masked_text_editing_controller.dart';
...
class _PaymentCardFormState extends State<PaymentCardForm> {
  ...
  final MaskedTextEditingController _cardNumberController = MaskedTextEditingController(mask: '0000 0000 0000 0000');
  final MaskedTextEditingController _expiryDateController = MaskedTextEditingController(mask: '00/00');
  final TextEditingController _cardHolderNameController = TextEditingController();
  final MaskedTextEditingController _cvvCodeController = MaskedTextEditingController(mask: '0000');
              ...
              Expanded(
                child: Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      FormLabel(text: L10n.of(context).paymentCardWidgetExpirationDateLabel),
                      ThemeTextInput(
                        controller: _expiryDateController,
                        hintText: L10n.of(context).paymentCardWidgetExpirationDatePlaceholder,
                        keyboardType: TextInputType.number,
                        onChanged: (String value) {
                          setState(() {
              ...
              Expanded(
                child: Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      FormLabel(text: L10n.of(context).paymentCardWidgetSecurityCodeLabel),
                      ThemeTextInput(
