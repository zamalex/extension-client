      ...
      child: ScrollablePositionedList.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          final TextStyle textStyle = isActive
              ? Theme.of(context).textTheme.subtitle1.bold.copyWith(color: Theme.of(context).tabBarTheme.labelColor)
              : Theme.of(context).textTheme.subtitle1.copyWith(color: Theme.of(context).tabBarTheme.labelColor.withOpacity(0.75));

          return InkWell(
            key: item.globalKey,
            onTap: () => BlocProvider.of<SearchBloc>(context).add(CategoryFilteredSearchEvent(activeSearchTab: item.id)),
            child: Container(
              //key: item.keyTabItem,
              ...
              decoration: BoxDecoration(
                border: Border(
                  bottom: BorderSide(
                    color: isActive ? Theme.of(context).tabBarTheme.labelColor : Theme.of(context).appBarTheme.color,
                    width: 2,
                  ),
                ),
              ),
