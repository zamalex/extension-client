            ...
            children: <Widget>[
              Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    const Padding(padding: EdgeInsetsDirectional.only(end: kPaddingS)),
                    StrutText(
                ...
                child: ListView(
                  ...
                  children: <Widget>[
                    UppercaseTitle(
                      ...
                      padding: const EdgeInsets.only(top: kPaddingM, bottom: kPaddingS),
                    ),
                    Row(
                      children: <Widget>[
                        StarRating(
                        ...
                        Padding(
                          ...
                          child: StrutText(
                            L10n.of(context).searchLabelRatingFilter(_starRating.round().toString()),
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        Padding(
                          padding: const EdgeInsets.only(top: kPaddingL, bottom: kPaddingS),
                          child: Text(L10n.of(context).searchDrawerDistanceRange(_rangeValues.start.round().toString(), _rangeValues.end.round().toString())),
                        ),
                      ],
                    ),
                    Column(
                            ...
                            setState(() {
                              if (values.end - values.start >= 20) {
                                ...
                                if (_rangeValues.start == values.start) {
                                  _rangeValues = RangeValues(_rangeValues.start, _rangeValues.start + 10);
                                } else {
                                  _rangeValues = RangeValues(_rangeValues.end - 10, _rangeValues.end);
                                }
                              }
                            });
                          },
              ...
              Padding(
                ...
                child: ThemeButton(
                  ...
                  onPressed: () {
                    BlocProvider.of<SearchBloc>(context).add(FilteredListRequestedSearchEvent());
