...
import 'package:salon/screens/voucher/widgets/voucher_info.dart';
...
class _VoucherScreenState extends State<VoucherScreen> {
  ...
  Future<void> _loadVoucher() async {
    BlocProvider.of<LoyaltyBloc>(context).add(VoucherRequestedLoyaltyEvent(widget.voucherId));
  }
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Scaffold(
        ...
        floatingActionButton: Container(
          padding: const EdgeInsetsDirectional.only(top: kPaddingM, end: kPaddingM),
