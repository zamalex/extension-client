...
import 'package:salon/screens/inbox/widgets/chat_list_item.dart';
...
class _ChatScreenState extends State<ChatScreen> with PortraitStatefulModeMixin<ChatScreen> {
  ...
  void initState() {
    ...
    BlocProvider.of<ChatBloc>(context).add(MessagesLoadedChatEvent(sessionId: widget.sessionId));
  }
