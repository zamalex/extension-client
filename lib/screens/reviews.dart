                ...
                children: <Widget>[
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      final int ratingCount = widget.location.reviews.where((ReviewModel review) => review.rate == rating).toList().length;
                          ...
                          children: <Widget>[
                            ...
                            Expanded(
                              child: LinearPercentIndicator(
                                ...
                                lineHeight: 6.0,
                                percent: ratingCount / widget.location.reviews.length,
                                trailing: Container(
                                  width: 32,
                                  child: StrutText(
