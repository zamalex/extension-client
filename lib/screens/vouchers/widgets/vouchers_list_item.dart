  ...
  Widget build(BuildContext context) {
    ...
    switch (widget.voucher.status) {
      case VoucherStatus.active:
        _date = L10n.of(context).vouchersDueDateActive(widget.voucher.dueDateTime.toLocalDateString).toUpperCase();
        break;
      case VoucherStatus.redeemed:
        _date = L10n.of(context).vouchersDueDateRedeemed(widget.voucher.redemptionDateTime.toLocalDateString).toUpperCase();
        _dateColor = Colors.green[700];
        break;
      case VoucherStatus.expired:
        _date = L10n.of(context).vouchersDueDateExpired(widget.voucher.dueDateTime.toLocalDateString).toUpperCase();
    ...
    return InkWell(
      onTap: () => Navigator.pushNamed(context, Routes.voucher, arguments: widget.voucher.id),
      child: Card(
        elevation: 1,
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(kBoxDecorationRadius),
          side: BorderSide(
            color: widget.voucher.status == VoucherStatus.redeemed ? Colors.lightGreen : Theme.of(context).cardColor,
            width: 2.0,
          ),
        ),
          ...
          child: Column(
            ...
            children: <Widget>[
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          StrutText(
                            sprintf('%s, %s', <String>[widget.voucher.location.address, widget.voucher.location.city]),
                            maxLines: 2,
              ...
              Row(
                ...
                children: <Widget>[
                  StrutText(
                    L10n.of(context).commonCurrencyFormat(widget.voucher.amount.toString()),
                    maxLines: 1,
                    style: Theme.of(context).textTheme.headline4.bold.copyWith(color: Theme.of(context).textTheme.bodyText1.color),
                  ),
                  const Padding(padding: EdgeInsetsDirectional.only(start: kPaddingS)),
                  StrutText(
              ...
              StrutText(
                _date,
                style: _dateColor != null ? Theme.of(context).textTheme.caption.copyWith(color: _dateColor) : Theme.of(context).textTheme.caption,
              ),
            ],
          ),
        ),
