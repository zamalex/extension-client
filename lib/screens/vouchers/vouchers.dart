...
import 'package:salon/screens/vouchers/widgets/vouchers_list_item.dart';
import 'package:salon/widgets/jumbotron.dart';
import 'package:salon/widgets/loading_overlay.dart';
import 'package:salon/widgets/ribbon.dart';
...
class _VouchersScreenState extends State<VouchersScreen> with SingleTickerProviderStateMixin {
  ...
  Widget _buildVouchersList(VoucherStatus status) {
    ...
    final List<VoucherModel> _filteredVouchers = _vouchers.where((VoucherModel voucher) => voucher.status == status).toList();
