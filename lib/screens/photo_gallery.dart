            ...
            Padding(
              ...
              child: Row(
                ...
                children: <Widget>[
                  StrutText(
                    _partnerName,
                    style: Theme.of(context).textTheme.subtitle2.copyWith(color: kWhite),
                  ),
                  StrutText(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return GestureDetector(
                    ...
                    child: Container(
                      width: 70,
                      margin: const EdgeInsetsDirectional.only(start: kPaddingM),
                      child: CachedNetworkImage(
                        cacheManager: AppCacheManager(),
                        imageUrl: _photos[index].getImageURL(ImageSize.view),
                        imageBuilder: (BuildContext context, ImageProvider imageProvider) => Container(
                          decoration: BoxDecoration(
                            border: Border.all(
                              color: index == _index ? Theme.of(context).accentColor : Theme.of(context).dividerColor,
                              width: 2,
                            ),
