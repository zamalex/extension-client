...
class LoyaltyRepository {
  ...
  Future<VoucherModel> getVoucher(int voucherId) async {
    final DataResponseModel rawData = await dataProvider.get('voucher_' + voucherId.toString());
  ...
  Future<List<VoucherModel>> getVouchers() async {
    ...
    final List<dynamic> _vouchers = rawData.data['vouchers'] as List<dynamic> ?? <dynamic>[];

    return _vouchers.map<VoucherModel>((dynamic json) => VoucherModel.fromJson(json as Map<String, dynamic>)).toList();
  }
}
