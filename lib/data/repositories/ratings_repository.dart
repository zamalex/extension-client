...
class RatingsRepository {
  ...
  Future<List<ReviewModel>> getRatings() async {
    ...
    final List<dynamic> _ratings = rawData.data['ratings'] as List<dynamic> ?? <dynamic>[];

    return _ratings.map<ReviewModel>((dynamic json) => ReviewModel.fromJson(json as Map<String, dynamic>)).toList();
  }
}
