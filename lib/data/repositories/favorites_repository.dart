...
class FavoritesRepository {
  ...
  Future<List<LocationModel>> getFavorites() async {
    ...
    final List<dynamic> _favorites = rawData.data['favorites'] as List<dynamic> ?? <dynamic>[];

    return _favorites.map<LocationModel>((dynamic json) => LocationModel.fromJson(json as Map<String, dynamic>)).toList();
  }
}
