...
class DataResponseModel {
  ...
  factory DataResponseModel.fromJson(Map<String, dynamic> json) {
    final List<dynamic> _errors = json['errors'] as List<dynamic> ?? <dynamic>[];

    return DataResponseModel(
      json['data'] as Map<String, dynamic> ?? <String, dynamic>{},
      _errors.map<DataResponseErrorModel>((dynamic json) => DataResponseErrorModel.fromJson(json as Map<String, dynamic>)).toList(),
    );
  }
