...
class AppointmentModel {
  ...
  factory AppointmentModel.fromJson(Map<String, dynamic> json) {
    ...
    return AppointmentModel(
      ...
      requestDate: DateTime.tryParse(json['request_date'] as String ?? '') ?? DateTime.now(),
      requestTime: json['request_time'] as String ?? '00:00',
      code: json['code'] as String ?? '',
      notes: json['notes'] as String ?? '',
      services: _services.map<ServiceModel>((dynamic json) => ServiceModel.fromJson(json as Map<String, dynamic>)).toList(),
    );
  }
  ...
  DateTime get appointmentStartDateTime {
    return DateTime.tryParse(DateFormat('yyyy-MM-dd', 'en').format(requestDate) + ' ' + requestTime);
  }
