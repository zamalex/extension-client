...
class PhotoModel {
  ...
  factory PhotoModel.fromJson(Map<String, dynamic> json) {
    ...
    return PhotoModel(
      json['id'] as int ?? 0,
      images.map<ImageModel>((dynamic json) => ImageModel.fromJson(json as Map<String, dynamic>)).toList(),
    );
  }
  ...
  String getImageURL(ImageSize forSize) {
    ...
    final ImageModel image = images.firstWhere((ImageModel image) => image.size == forSize, orElse: () => null);
