...
import 'package:salon/data/repositories/chat_repository.dart';
...
class ChatBloc extends Bloc<ChatEvent, ChatState> {
  ...
  Stream<ChatState> _mapLoadInboxChatEventToState(InboxLoadedChatEvent event) async* {
  ...
  Stream<ChatState> _mapLoadMessagesChatEventToState(MessagesLoadedChatEvent event) async* {
    yield LoadMessagesInProgressChatState();

    final ChatSessionModel _session = await const ChatRepository().getChatSession(sessionId: event.sessionId);
